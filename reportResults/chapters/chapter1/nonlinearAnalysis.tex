...
%
\begin{flalign}
  \ddot{x} &=  \frac{1}{M+m} ( F - m l \sin \theta \dot{\theta} + m l \cos \theta \ddot{\theta} ) \ \ \ . & %\unit{N \cdot m}
...
\begin{flalign}
  ...
  \left(
    \frac{1}{M+m} ( F - m l \sin \theta \dot{\theta} + m l \cos \theta \ddot{\theta} )
  \right)
...
%
\begin{flalign}
  \left( m l^2 - \frac{m^2 l^2}{M + m} \cos \theta \right) \ddot{\theta}
  + \left( \frac{m^2 l^2}{M + m} \cos \theta \sin \theta \right) \dot{\theta}^2
   - m g l \sin \theta - \frac{m l}{M + m} \cos \theta F &=  0   \ \ \ , & %\unit{N \cdot m}
